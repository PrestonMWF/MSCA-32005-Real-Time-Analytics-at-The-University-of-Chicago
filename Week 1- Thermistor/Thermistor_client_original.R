...
#best training score: 100 (error term of 75.7, ~24 less than target of 100)
#settings: 450 groups, .25 abs diff
#stable rle == 25, unstable rle == 1, time threshold 15

#best test score: 100 (error term of 56.6, ~43.4 less than target of 100)
#settings: 450 groups, .25 abs diff
#stable rle == 1, unstable rle == 1, time threshold 15
